...
void main(List<String> args) {
  ...
  /* 4- 5 elemanlı iki farklı liste oluşturun.Elemanlar 0-50'ye rastgele değerlerden oluşsun.Bu elemanları tek bir listeye aktarsın.Oluşan son listenin elemanlarının karelerini tutan set 
