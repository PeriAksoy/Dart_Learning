...
void main(List<String> args) {
  ...
  print("Kaç not girildi: ${girilenNotlar.length}");
  double ortalama = ListedekiElemanlarOrtalamasi(girilenNotlar);
  print("Notların ortalamasi: $ortalama");
}

double ListedekiElemanlarOrtalamasi(List<int> liste) {
  int toplam = 0;
